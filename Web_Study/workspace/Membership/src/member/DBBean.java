...
public class DBBean {
	...
	private String userAdd1;		//주소
	private String userAdd2;		//상세주소
	private String userAdd3;		//참고항목
	...
	public boolean insertDB() {
		...
		try {
			...
			pstmt.setString(15, userAdd1);
			pstmt.setString(16, userAdd2);
			pstmt.setString(17, userAdd3);
			
			//DML(insert, update, delete 등) 작업 시 executeUpdate() 메소드 호출함!!
			pstmt.executeUpdate(); 			
		}catch(Exception e) {
